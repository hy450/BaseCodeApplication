...
//  cookizwatch
//
//  Created by hanyong on 21/04/2019.
...
/**
 * RxBus 참고 사이트
 #https://github.com/ridi/RxBus-Swift
 */
...
extension RxBus {
    ...
    public func listen<T: BusEvent>(event: T.Type ) -> Observable<T> {
        return asObservable(event: event, sticky: false, priority: 0)
    }
}
